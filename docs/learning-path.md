...
This guide outlines a 6.5-week journey to transform you from a beginner into a job-ready, AI-augmented developer with a professional portfolio.
...
2.  **[Understanding Shell Commands](./understanding-shell-commands.md)** — Learn how AI agents translate natural language to shell commands. Focus on understanding *capabilities* rather than memorizing syntax.
3.  **Run Your First Project** — Start with the **[Content Generator](./project-01-content-generator/)**. Follow the instructions to get it running. The goal is not to understand every line of code, but to experience the power of an AI-augmented workflow firsthand.
4.  **Understand the Workflow** — Pay attention to how you use natural language to instruct the AI agent. Notice the pattern: you describe *what* you want, and the agent handles the *how*.
5.  **[Spec-Driven Development Session](./setup/spec-driven-development-session.md)** — Read this overview to understand the concept of spec-driven development, which will be a key part of your workflow in the coming weeks.
