...
**[[understanding-shell-commands]]** - Shell command capabilities for AI-assisted development
- How AI agents translate natural language to shell commands
- Understanding capabilities over syntax memorization
- Cross-platform command reference (Linux/Mac/Windows)
- Top 20 most essential command categories
- **Related**: [[understanding-ai-coding-assistants]], [[glossary/Claude-Code]], [[./setup/command-line-essentials]]
...
1. **[[understanding-shell-commands]]** - Understand how AI translates natural language to commands
2. **[[glossary/api-key]]** - Understand authentication
3. **[[glossary/environment-variables]]** - Learn secure configuration
4. **[[glossary/Claude-Code]]** - Introduction to your AI coding assistant
5. **[[glossary/coding-agents]]** - Explore the full landscape
...
**Current Entries**: 6 core concepts
- Fundamentals: 1
- Tools & Platforms: 2
- Security & Configuration: 3

**Coverage Areas**:
- ✅ Shell Commands & Terminal Fundamentals
- ✅ AI Coding Agents
...
|---------|------|------------|------------------------|
| [[understanding-shell-commands]] | Fundamentals | Beginner | [[./setup/command-line-essentials]] |
...
**Recent Updates**:
- 2025-11-17: Added [[understanding-shell-commands]] fundamentals guide
